...
urlpatterns = [
    ...
    path('topwear/', views.Topwear, name='top'),
    path('topwear/<slug:data>/', views.Topwear, name='topdata'),
    path('bottomwear/', views.Bottomwear, name='bottom'),
    path('bottomwear/<slug:data>/', views.Bottomwear, name='bottomdata'),
    path('accounts/login/', auth_views.LoginView.as_view(template_name='app/login.html', authentication_form=LoginForm), name='login'),
    path('logout/', views.logout_page, name='logout'),
    path('passwordchange/', auth_views.PasswordChangeView.as_view(template_name='app/passwordchange.html', form_class=MyPasswordChangeForm, success_url='/profile/'), name='passwordchange'),
